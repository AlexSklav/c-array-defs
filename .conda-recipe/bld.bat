...
endlocal
xcopy /S /Y /I /Q "%SRC_DIR%"\c_array_defs\Arduino\CArrayDefs "%PREFIX%"\Library\include
xcopy /S /Y /I /Q "%SRC_DIR%"\c_array_defs\Arduino\CArrayDefs "%PREFIX%"\Library\include\Arduino\CArrayDefs
